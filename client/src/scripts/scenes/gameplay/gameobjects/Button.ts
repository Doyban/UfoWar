...
export default class Button extends Phaser.GameObjects.Sprite
{
    ...
    constructor(scene: any, config: any)
    {
        ...
        let text_style = { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize: '32px' };
        let text = config.text.content || "text";
        this.buttonText = new Phaser.GameObjects.Text(scene, 0, 0, text, text_style);
